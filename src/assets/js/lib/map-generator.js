export default class MapGen {
  ...
  mapInit() {
    ...
    const mapOptions = {
      ...
      zoom: (this.mapSelector.getAttribute('data-zoom')) ? parseInt(this.mapSelector.getAttribute('data-zoom')) : 14,
